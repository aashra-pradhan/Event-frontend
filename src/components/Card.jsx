...
const Card = ({
  ...
  return (
    <>
      <Link to={link}>
        <div className=" relative product-card block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 h-[400px] w-[250px]">
          <img
          ...
          <div className="p-6">
            ...
            <h4 className="text-gray-600">{shortDescription}</h4>
            <h3 className="text-gray-600 mt-5">Date: {date}</h3>
